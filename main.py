...
def updateLocalObject(name, local_obj):
    ...
    if name not in local_obj['business_name']:
        ...
        local_obj['business_name'][name]['timeVisited'] = []
        local_obj['business_name'][name]['content'] = {}
        local_obj['business_name'][name]['changeSinceLastVisited'] = {}

    if timeStamp in local_obj['business_name'][name]['timeVisited']:
        return local_obj
    ...
    if len(local_obj['business_name'][name]['timeVisited']) > 1 and local_obj['business_name'][name]['timeVisited'][-2] != timeStamp:
        lastVisited = local_obj['business_name'][name]['timeVisited'][-2]
